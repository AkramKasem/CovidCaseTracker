...
public class GetAllCountry {
	...
	public static void main(String[] args) throws Exception {
		...
		String url = "https://www.worldometers.info/coronavirus/country/egypt/";
...
//		func();
	...
	static void func() throws IOException {
		URL url = new URL("https://www.countryflags.com/wp-content/uploads/egypt-flag-png-large.png");
		BufferedImage img = ImageIO.read(url);
		File file = new File("E:\\The World Of Java\\ECLIPSE\\Corona\\image\\download2.png");
